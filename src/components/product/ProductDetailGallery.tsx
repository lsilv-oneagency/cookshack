...
export default function ProductDetailGallery({
  ...
  if (list.length === 0) {
    return (
      <div className="relative min-h-[min(60vw,420px)] w-full overflow-hidden rounded border border-[#E8E0D8] bg-white lg:aspect-square lg:min-h-0">
        <ProductImage
          src={undefined}
          alt={productName}
  ...
  return (
    <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:gap-4">
            ...
            <button
              ...
              className={`relative h-20 w-20 shrink-0 overflow-hidden rounded border-2 transition lg:h-[4.5rem] lg:w-full ${
                i === safeIndex
                  ...
                  : "border-[#E8E0D8] hover:border-[#D52324]/50"
              }`}
      ...
      <div className="relative min-h-[min(60vw,420px)] w-full flex-1 overflow-hidden rounded border border-[#E8E0D8] bg-white lg:aspect-square lg:min-h-0">
        <ProductImage
          src={main}
          alt={productName}
          productCode={productCode}
