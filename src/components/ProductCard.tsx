    ...
    >
      <div className="flex flex-1 flex-col gap-4 p-5">
        ...
        <button
          ...
          className="mt-auto flex w-full items-center justify-center gap-2 rounded-xl bg-[#AE1B07] py-3.5 text-sm font-bold text-white transition hover:bg-[#8E1405] disabled:cursor-not-allowed disabled:opacity-50"
        >
          {adding ? (
            <>
