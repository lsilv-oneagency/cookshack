...
export default function ProductCard({ product, categoryLabel }: ProductCardProps) {
  ...
  return (
    <Link
      ...
      className="group flex h-full flex-col overflow-hidden rounded-md border border-neutral-200 bg-white p-2.5 shadow-sm transition hover:border-[#D6D6D6] hover:shadow-md sm:p-3"
    >
      <div className="flex flex-1 flex-col gap-2.5">
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-1.5 text-left">
          {categoryLabel ? (
        ...
        <button
          ...
          className="mt-auto flex w-full items-center justify-center gap-1.5 rounded-full bg-[#D52324] py-1.5 text-xs font-bold text-white shadow-sm transition hover:brightness-[0.95] disabled:cursor-not-allowed disabled:opacity-50 sm:py-2 sm:text-sm"
        >
          {adding ? (
            <>
