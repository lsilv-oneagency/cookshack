  ...
  return (
    <nav className="flex items-center justify-center gap-1.5 mt-12" aria-label="Pagination">
      <button
        ...
        className="p-2 rounded text-[#6B6B6B] hover:text-[#E85D04] hover:bg-white border border-transparent hover:border-[#E8E0D8] disabled:opacity-30 disabled:cursor-not-allowed transition"
        aria-label="Previous"
      >
