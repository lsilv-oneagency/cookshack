        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          {items.length === 0 ? (
            <div className="text-center py-24">
              <IconShoppingCart className="w-20 h-20 mx-auto mb-6 text-[#D52324]" aria-hidden />
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div key={item.product_code} className="flex gap-5 p-5 bg-white border border-[#E8E0D8] rounded shadow-sm hover:border-[#D52324]/30 transition">
                      ...
                      <div className="flex-1 min-w-0">
                        <Link
                          ...
                          className="text-sm font-heading font-bold text-[#1A1A1A] uppercase tracking-wide hover:text-[#D52324] transition line-clamp-2 leading-snug"
                        >
                          {item.product_name}
                        </Link>
                        {item.product_sku && (
              ...
              <div className="lg:col-span-1">
                <div className="bg-white border border-[#E8E0D8] rounded shadow-sm p-6 sticky top-24">
                  ...
                  <Link
                    href="/shop"
                    className="block w-full py-3 text-center text-xs font-heading font-bold tracking-widest uppercase text-[#6B6B6B] hover:text-[#D52324] transition mt-2"
                  >
                    Continue Shopping
                  </Link>
                  ...
                  <div className="mt-4 pt-4 border-t border-[#E8E0D8] flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs text-[#9A9A9A]">
                    ...
                    <span>·</span>
                    <a href="tel:18004230698" className="inline-flex items-center gap-1.5 hover:text-[#D52324] transition">
