              ...
              {images.length > 1 && (
                <div className="grid grid-cols-4 gap-2">
                  {images.slice(0, 4).map((img, i) => (
                    <div
                      key={i}
                      className="relative aspect-square bg-white border border-[#E8E0D8] rounded overflow-hidden hover:border-[#D52324] transition cursor-pointer"
                    >
                      <Image
                        src={img}
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="grid grid-cols-3 gap-3">
                {(
                  ...
                  <div key={label} className="bg-white border border-[#E8E0D8] rounded p-3 text-center">
                    <div className="flex justify-center mb-1 text-[#D52324]">
              ...
              {product.descrip && (
                <div className="border-t border-[#E8E0D8] pt-5">
                  ...
                  <div
                    className="prose prose-sm max-w-none text-[#3D3D3D] leading-relaxed prose-headings:font-heading prose-headings:uppercase prose-headings:tracking-wide prose-a:text-[#D52324] prose-a:no-underline hover:prose-a:underline"
            ...
            <section className="mt-20">
              <div className="flex items-end justify-between mb-8">
                <div>
                  ...
                  <div className="w-12 h-1 bg-[#D52324] mt-2" />
                </div>
              </div>
