  ...
  return (
    <>
      ...
      <div className="bg-white min-h-[60vh] flex flex-col items-center justify-center text-center px-4 py-20">
        <IconMagnifyingGlass className="w-16 h-16 mx-auto mb-6 text-[#D52324]" aria-hidden />
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link
            href="/"
            className="px-8 py-3.5 bg-[#D52324] text-white font-heading font-bold tracking-widest uppercase text-sm hover:brightness-[0.94] transition rounded"
          >
            Go Home
          </Link>
          <Link
            href="/shop"
            className="px-8 py-3.5 bg-white text-[#1A1A1A] font-heading font-bold tracking-widest uppercase text-sm border border-[#D4C8BE] hover:border-[#D52324] hover:text-[#D52324] transition rounded"
          >
            Browse Products
          </Link>
        </div>
